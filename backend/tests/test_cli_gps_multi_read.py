...
from app.gps.cli_provider import CLIGPSProvider, GPSReadError, _clear_gps_error


class TestCLIGPSMultiRead:
    def setup_method(self):
        _clear_gps_error()

    @pytest.fixture
    def fake_gps_fix_late(self):
...
"""
    ...
    @pytest.fixture
    def fake_gps_missing_lat_lon(self):
...
"""
    ...
    def test_get_location_picks_fix_from_last_line(self, fake_gps_fix_late):
    ...
    def test_get_location_no_fix_raises(self, fake_gps_no_fix):
    ...
    def test_get_location_fix_first_line(self, fake_gps_fix_first):
    ...
    def test_get_location_missing_lat_lon_raises(self, fake_gps_missing_lat_lon):
